      ...
      <Card shadow style={{ paddingVertical: theme.sizes.base * 2 }}>
        ...
        <Block center>
          ...
          <Text>
            ...
            <Text gray transform="uppercase">Driving bonus</Text>
          </Text>
        </Block>
      </Card>
    )
      ...
      <Card style={{ padding: 0, overflow: 'hidden' }}>
        ...
        >
          <Marker
            rotation={-15}
            anchor={{ x: 0.5, y: 0.5 }}
            coordinate={{ latitude: 25.02060, longitude: 121.333229 }}
          >
        ...
        <TouchableOpacity
          ...
          onPress={() => alert('get your current Location')}
        >
