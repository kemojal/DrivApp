    ...
    return (
      ...
      >
        <Card shadow style={{ paddingVertical: theme.sizes.padding }}>
          ...
          <Block>
            <Block center>
              <Text h1 primary spacing={1.7}>$9.77</Text>
              <Text spacing={0.7}>Monthly Rewards</Text>
            </Block>
            ...
            <Block row>
              ...
              <Block center>
                <Text size={20} spacing={0.6} primary style={{ marginBottom: 6 }}>42</Text>
  ...
  renderAwards() {
    return (
      <LinearGradient
        ...
        colors={["#ff0057", theme.colors.accent]}
      >
        ...
        <Block middle>
          <Text size={theme.sizes.base} spacing={0.4} medium white>Won!</Text>
          <Text size={theme.sizes.base} spacing={0.4} medium white>Safe Driver Award!</Text>
        </Block>
      </LinearGradient>
    )
  }
